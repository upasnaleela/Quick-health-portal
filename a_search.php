...
<html lang="en">
    <head>
        <title>Quick Health | Search</title>
    ...
    <body>
        ...
        <div class="contact">
            <div class="container">
                <h4 class="w3ls-title w3ls-title1"><b>Display All The Medicine That Start With <?php echo  $ans  ?></b></h4>
                <div class="map-info">
                    ...
                    <div class="clearfix">
                                            ...
                                            <?php
                                                    ...
                                                    $fetch = mysqli_query($con, "SELECT title FROM medicine WHERE title REGEXP '^[$ans].*$'") or die(mysqli_error());
                         ...
                         <form action="a-z_retrieve.php" method="post">
                            <input type="search" name="detail" placeholder="Enter Medicine Name" required="">
