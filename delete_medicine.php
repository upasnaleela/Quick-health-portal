            ...
            <div id="content">
                <div class="container">
				   <b>  <h1 class="margin-bottom-30">
                          <p><center>Delete Medicine</center>
                            </h2>
                            </b>
							<?php
														...
														echo "<tr> <th>&nbsp;&nbsp;Title</th> <th>&nbsp;&nbsp;Company name</th> <th>&nbsp;&nbsp; Price</th> <th>&nbsp;&nbsp;properties</th> <th>&nbsp;&nbsp;Limitation</th> <th>&nbsp; &nbsp; Side Effects </th><th>Image</th><th>Delete it</th></tr>";
    													while($row = mysqli_fetch_assoc($result)) {
                                                                                                    ...
                                                                                                    <img src="../../ADMIN/HTML/Images/<?php echo $row['image'];?>" height="50" width="50"/>															<?php
																									 ...
																									 ?>
																									 <a href="delete_medicines.php?id=<?php echo $row['id'];?>">Delete </a>
																									 </tr>
                  </p>
                          <p>
                            <?php
