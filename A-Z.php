...
<html lang="en">
    ...
    <body>
        ...
        <div class="contact">
            <div class="container">
                <h4 class="w3ls-title w3ls-title1"><b>Search Medicine By A-Z</b></h4>
                <div class="map-info">
                  
                    <div class="clearfix"></div>
                </div>
                <div class="contact-form-row">
                    <h4 class="w3ls-title w3ls-title1"></h4>
                    <div class="col-md-7 contact-left">
                       <form action="a_search.php" method="post">
                            <input type="search" name="search" placeholder="Enter First Alphabet" required="">
